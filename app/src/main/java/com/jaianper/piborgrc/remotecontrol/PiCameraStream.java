package com.jaianper.piborgrc.remotecontrol;
...
import com.jaianper.piborgrc.R;
import com.jaianper.piborgrc.customviews.RCButton;
...
public class PiCameraStream extends Activity implements SurfaceHolder.Callback {
    ...
    private void setButtons() {
        ...
        btnForward.setOnTouchListener((view, motionEvent) -> {
        ...
        btnReverse.setOnTouchListener((view, motionEvent) -> {
            int action = motionEvent.getActionMasked();
