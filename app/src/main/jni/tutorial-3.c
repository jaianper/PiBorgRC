//
// Created by J414NP3R on 19/07/2017.
//
...
static void *app_function (void *userdata) {
    ...
    /* Build pipeline */
    data->pipeline = gst_parse_launch("udpsrc port=9000 ! application/x-rtp, clock-rate=90000, payload=96 ! rtpjitterbuffer ! rtph264depay ! avdec_h264 ! glimagesink", &error);
    if (error) {
